...
const M3U_URL = "http://tv.zeuspro.xyz:2052/get.php?username=Y8j7ByPgL2&password=MC5yEDwNEx&type=m3u_plus"; // Updated URL
...
// List channels with pagination and updated horizontal cross-fade style menu
async function listChannels(chat_id, page) {
  ...
  // Updated layout: all channel buttons are arranged horizontally in a single row
  ...
  // Enhanced digital menu message for listing channels with a simulated cross-fade sideways transition effect
  // Note: Telegram API does not support animations; the cross-fade sideways effect is simulated
  const listMessage = "╔═☆ Channel List ☆═╗\nSelect a channel to play:\n\n(Transition effect: pages slide sideways in a cross-fade style)";
