...
const IPTV_APP_MESSAGE = "Please use IPTV app to open this link: [IPTV App](http://play.google.com/store/apps/details?id=ru.iptvremote.android.iptv)";
...
async function fetchChannels() {
  ...
  console.log("✅ Fetched M3U Content:", content.substring(0, 500)); // Log first 500 characters for debugging
  ...
  console.log("✅ Extracted Channels:", channels.length); // Debugging log
  return channels;
}
